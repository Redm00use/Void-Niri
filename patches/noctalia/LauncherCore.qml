...
Rectangle {
  ...
  readonly property color rofiMainBg: "#11111be6"
  readonly property color rofiMainFg: "#cdd6f4"
  readonly property color rofiMainBr: "#b4befe"
  readonly property color rofiMainEx: "#f5e0dc"
  readonly property color rofiSelectBg: "#9aa0da"
  readonly property color rofiSelectFg: "#11111b"
  ...
  readonly property int effectiveIconSize: launcherDensity === "comfortable" ? 42 : (launcherDensity === "default" ? 32 : 20)
  readonly property int badgeSize: Math.round(effectiveIconSize * Style.uiScaleRatio)
  readonly property int entryHeight: Math.round(badgeSize + (launcherDensity === "compact" ? Style.marginM : (Style.marginL + Style.marginXS)))
  ...
  ColumnLayout {
    ...
    RowLayout {
      ...
      NTextInput {
        ...
        Component.onCompleted: {
          if (searchInput.inputItem) {
            ...
            if (searchInput.inputItem.placeholderTextColor !== undefined)
              searchInput.inputItem.placeholderTextColor = Qt.alpha(root.rofiMainFg, 0.45);
            if (searchInput.inputItem.color !== undefined)
              searchInput.inputItem.color = root.rofiMainFg;
          }
        }
      }
      ...
      NIconButton {
        ...
        colorBg: root.rofiMainBg
        colorFg: root.rofiMainBr
        colorBgHover: root.rofiSelectBg
        colorFgHover: root.rofiSelectFg
        colorBorder: root.rofiMainBr
        colorBorderHover: root.rofiMainBr
    ...
    Component {
      ...
      NListView {
        ...
        delegate: NBox {
          ...
          clip: true
          color: entry.isSelected ? root.rofiSelectBg : Qt.rgba(0.07, 0.07, 0.11, 0.88)
          ...
          ColumnLayout {
            id: contentLayout
            anchors.fill: parent
            anchors.margins: root.isCompactDensity ? Style.marginXXS : Style.marginS
            spacing: root.isCompactDensity ? Style.marginXXS : Style.marginS

            // Top row - Main entry content with action buttons
            RowLayout {
              Layout.fillWidth: true
              spacing: root.isCompactDensity ? Style.marginXS : Style.marginS
              ...
              Item {
                ...
                Rectangle {
                  ...
                  color: Qt.alpha(root.rofiMainBr, 0.16)
                ...
                Loader {
                  ...
                  Component {
                    ...
                    NIcon {
                      ...
                      color: entry.isSelected ? root.rofiSelectFg : root.rofiMainFg
                    }
                  }
                ...
                NText {
                  ...
                  pointSize: modelData.displayString ? (modelData.displayStringSize || Style.fontSizeXXL) : Style.fontSizeXL
                  font.weight: Style.fontWeightSemiBold
                  color: modelData.displayString ? root.rofiMainFg : root.rofiSelectFg
                }
              ...
              ColumnLayout {
                ...
                NText {
                  ...
                  pointSize: Style.fontSizeS
                  color: entry.isSelected ? Qt.alpha(root.rofiSelectFg, 0.8) : Qt.alpha(root.rofiMainFg, 0.7)
                  elide: Text.ElideRight
                  maximumLineCount: 1
                  Layout.fillWidth: true
    ...
    Component {
      ...
      Item {
        ...
        NBox {
          anchors.fill: parent
          color: Qt.alpha(root.rofiMainBg, 0.96)
          border.color: root.rofiMainBr
          border.width: Style.borderS
          Layout.fillWidth: true
          Layout.fillHeight: true
      ...
      NGridView {
        ...
        delegate: Item {
          ...
          NBox {
            ...
            color: gridEntryContainer.isSelected ? root.rofiSelectBg : Qt.rgba(0.07, 0.07, 0.11, 0.88)
                ...
                Loader {
                  ...
                  Component {
                    ...
                    NIcon {
                      ...
                      visible: modelData.icon && !modelData.displayString
                      color: gridEntryContainer.isSelected ? root.rofiSelectFg : root.rofiMainFg
                    }
                  }
    ...
    ColumnLayout {
      ...
      NText {
        ...
        color: Qt.alpha(root.rofiMainFg, 0.55)
